...
-- -----------------------------------------------------
-- Table `server-data`.`message-author-receiver`
-- -----------------------------------------------------
...
# ////////////////////////////////////////////////////////////////////////////////////////////////////
create procedure getPersonalUserInfo(in cookie1 varchar(200))
begin
    select name,password,mail from users where cookie=cookie1;
end;
# ////////////////////////////////////////////////////////////////////////////////////////////////////
